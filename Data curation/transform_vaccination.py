...
# doses based in column dose
doses = [
    '1ª dose', '2ª dose', 'unica', '3ª dose', '1º reforco', '2º reforco',
    '1ª dose revacinacao', '2ª dose revacinacao' '3º reforco', 'dose',
    'dose adicional', 'reforco', 'revacinacao', 'tratamento com uma dose',
    'tratamento com dezessete doses'
]

# create column corresponding to dose
for dose in doses:
